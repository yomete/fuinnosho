...
This document contains important guidelines and reminders for Codex when working on the Fuinnosho project.
...
This ensures Codex has access to all the latest features when working with your film inventory through the MCP interface.
