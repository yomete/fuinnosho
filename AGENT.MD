...
This document contains important guidelines and reminders for AI Agents when working on the Fuinnosho project.

## Supabase

Don't run supabase commands. just write the migration to a file and i'll copy and paste it into the supabase dashboard.
...
This ensures Claude Desktop app has access to all the latest features when working with your film inventory through the MCP interface.
