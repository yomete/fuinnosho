...
class FilmInventoryMCPServer {
  ...
  async createChallenge(args: any) {
  ...
  async getChallengePrompts(args: any) {
    const { challenge_id } = args;
  ...
  async getChallengeProgress(args: any) {
    const { challenge_id } = args;
  ...
  async updateChallengeProgress(args: any) {
  ...
  async getChallengeFilmRolls(args: any) {
    const { challenge_id } = args;
  ...
  async getTodaysPrompt(args: any) {
    const { challenge_id } = args;
  ...
  async getChallengePrompt(args: any) {
  ...
  async updateChallengePrompt(args: any) {
    const { prompt_id, ...updates } = args;
  ...
  async getProgressForPrompt(args: any) {
    const { prompt_id } = args;
