...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-full bg-[#1a1614]/80 border border-[#2a2420] p-1 text-[#8a8078]",
      className
    )}
    {...props}
  />
