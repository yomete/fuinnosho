...
export const QUERY_TIMEOUT_MS = Number(process.env.MCP_QUERY_TIMEOUT_MS) || 10000;
...
export function createMcpSupabaseClient() {
    ...
    if (!supabaseUrl || (!serviceRoleKey && !supabaseKey)) {
        throw new Error("Missing Supabase environment variables. Set NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY (or NEXT_PUBLIC_SUPABASE_ANON_KEY)");
    }
